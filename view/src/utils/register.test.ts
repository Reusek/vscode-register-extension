...
describe("Register value conversion", () => {
    describe("foat32_t conversion", () => {
        it.each([
            ...
            ["0x42280000", 42]
        ])("Value %s should equel %s", (a: string, r: number) => {
            let o = new Register(a).getDecoded(RegisterTypes.F32);
            expect(o).toEqual(r);
        });
    });
    ...
    describe("int8_t conversion", () => {
        it.each([
            ...
            let o = new Register(a).getDecoded(RegisterTypes.I8);
            expect(o).toEqual(r);
        });
    });
    ...
    describe("uint8_t conversion", () => {
        it.each([
            ...
            let o = new Register(a).getDecoded(RegisterTypes.U8);
            expect(o).toEqual(r);
        });
    });
    ...
    describe("uint16_t conversion", () => {
        it.each([
            ...
            let o = new Register(a).getDecoded(RegisterTypes.U16);
            expect(o).toEqual(r);
        });
    });
    ...
    describe("uint32_t conversion", () => {
        it.each([
            ...
            let o = new Register(a).getDecoded(RegisterTypes.U32);
            expect(o).toEqual(r);
        });
    });
});